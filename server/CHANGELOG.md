...
* Partially address Issue #33: Re-organized as a Workspace w/ 2
  members: 'data' and 'server' corresponding respectively to the
  2 crates: 'xapi-data' and 'xapi-rs'.  This one, being the the
  original single project/crate is now bumped to version 0.2.0.
...
* Upgrade `test-context` to 0.5.4.
* Upgrade `openssl` to 0.10.75.
* Use latest secondary dependent crates.
